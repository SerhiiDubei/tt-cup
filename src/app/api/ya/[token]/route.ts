...
const FIELDS =
  'num, kind, first_name, last_name, nick, telegram, instagram, phone, level, is_sportik, volunteer, volunteer_roles, pay_amount, paid, paid_claimed_at, pay_base, pay_discount_pct, pay_status, pay_reason, pay_reason_code, auth_user_id, created_at';
