  ...
  return (
    <div className="kb-root"><div className="kb-phone yk">
      ...
      <section className="yk-sec">
        ...
        <ol className="yk-steps">
          ...
          <li className="yk-step"><i>3</i><div>
            <b>11–12 вересня граєш вісім матчів</b>
      ...
      <section className="yk-sec">
        ...
        <p>Онлайн-частина — на цьому ж сайті: жеребкування {'\u2014'} 10 вересня, матчі й таблиця
          з 11 по 12 вересня в кабінеті учасника.</p>
