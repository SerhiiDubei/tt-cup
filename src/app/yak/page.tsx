    ...
    <div className="kb-root"><div className="kb-phone yk">
      <div className="kb-hd">
        ...
        <div className="kb-who">
          ...
          <span>DRUID BATTLE CUP · 19 вересня</span>
        </div>
      </div>
      ...
      <section className="yk-sec">
        ...
        <ol className="yk-steps">
          <li className="yk-step"><i>1</i><div>
            <b>Реєструєшся — до 15 вересня, 23:59</b>
            <span>Місць 32. Хто перший заплатив — той і грає: місце закріплює внесок, а не намір.</span>
          </div></li>
          <li className="yk-step"><i>2</i><div>
            <b>15 вересня система розкидає пари</b>
          ...
          <li className="yk-step"><i>3</i><div>
            <b>16–18 вересня граєш вісім матчів</b>
          ...
          <li className="yk-step"><i>4</i><div>
            <b>19 вересня — День Х на Друїді</b>
      ...
      <section className="yk-sec">
        ...
        <p>19 вересня о <em>13:00</em> — міні-ігри для всіх охочих, навіть якщо ти не в сітці. Стаканчики, відро і ще пара сюрпризів.</p>
      ...
      <section className="yk-sec">
        ...
        <p style={{ marginTop: 12 }}>Ціна одна для всіх і не залежить від того, коли ти записався.
          <em> Місце тримає оплата</em> — поки внеску немає, воно вільне для наступного.</p>
      </section>
      ...
      <section className="yk-sec">
        ...
        <p>Онлайн-частина — на цьому ж сайті: жеребкування {'\u2014'} 15 вересня, матчі й таблиця
          з 16 по 18 вересня в кабінеті учасника.</p>
