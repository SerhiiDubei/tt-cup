...
const REG_END = new Date('2026-09-18T23:59:59+03:00'); // реєстрація закривається
...
function Bands({ phase }: { phase: Phase }) {
  return (
    <div className="kb-bands">
      <div className={'kb-band reg' + (phase === 'before' ? ' now' : '')}><b>Реєстрація</b><span>1—18</span></div>
        ...
        <div className="kb-due">
          ...
          {p.pay_status === 'failed' ? (
            ...
            <p>Місце <b>№{p.num}</b> за тобою поки лише записане, але не закріплене.
              Закріплює його внесок — до <b>18 вересня, 23:59</b>.</p>
          )}
      ...
      <div className="kb-now">
        ...
        {open ? (
          <>
            ...
            <p className="kb-sub">Закриється 18 вересня, 23:59</p>
          </>
        ) : phase === 'league' ? (
