  ...
  if (mode === 'volunteer') {
    return (
      <main className="jn-root"><div className="jn-wrap">
        ...
        <p className="jn-lead">День Х — 19 вересня на ДРУЇДІ. Обери, чим готовий помогти.</p>
    ...
    <main className="jn-root"><div className="jn-wrap">
      ...
      {step === 3 && (
        <>
          ...
          <p className="jn-lead">Ліга 16–18 вересня + День Х 19 вересня з фіналами і міні-іграми. Все на ДРУЇДІ.</p>
